...
import com.yassineabou.clock.ui.theme.Black100
import com.yassineabou.clock.ui.theme.Blue100
import com.yassineabou.clock.ui.theme.ClockTheme
import com.yassineabou.clock.util.checkDate
import com.yassineabou.clock.util.checkNumberPicker
import com.yassineabou.clock.util.components.CustomChip
import com.yassineabou.clock.util.components.NumberPicker
import com.yassineabou.clock.util.components.imePaddingIfTrue
    ...
    Box(modifier = modifier) {
        Row(
            ...
            TextButton(
                ...
                Text(text = stringResource(id = com.yassineabou.clock.R.string.cancel))
            }
            TextButton(
                onClick = {
                    save()
